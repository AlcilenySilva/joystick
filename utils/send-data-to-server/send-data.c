...
#define SERVER_IP "192.168.1.84"  // Troque por seu ip
#define SERVER_PORT 3000       // Troque por sua porta
#define SERVER_PATH "/posicao" // Troque por sua rota
...
void create_request_json(int x, int y, const char* direcao)
{
    const char *type_method = "POST";
    const char *path = SERVER_PATH;
    char json_request[256];

    // Monta o JSON com os dados do joystick
